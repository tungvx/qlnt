...
#    url(r'dsnghi/(?P<class_id>\w+)/(?P<day>\w+)/(?P<month>\w+)/(?P<year>\w+)$', 'school.views.ds_nghi'),
    url(r'datecheck','school.views.date_check'),
    ...
    url(r'success$','school.views.change_success'),
    ...
    url(r'import/subjectAgenda/(?P<subject_id>\w+)$','school.views.import_agenda'),
    ...
    url(r'convertMark/$', 'school.helptools.convertMark'),
	)
