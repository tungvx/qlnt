                    ...
                    try:
                        ...
                        for id in ids:
                            if id:
                                ...
                                reg.default_password = user.password
                                reg.save()
                                ...
                                u'Mật khẩu:' + unicode(user.username), to_addr=[reg.register_email])
...
GMAIL_LOGIN = 'support@truongnha.com'
GMAIL_PASSWORD = 'truongnhadotcom'
